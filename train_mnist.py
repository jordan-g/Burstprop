...
if use_node_pertubation:
    ...
    if conv_net:
        net = MNISTConvNet(input_channels=1, p_baseline=p_baseline, weight_fa_std=weight_fa_std, weight_r_range=weight_r_range, weight_fa_learning=weight_fa_learning, recurrent_input=recurrent_input, weight_r_learning=weight_r_learning, device=device).to(device)
    else:
        net = MNISTNet(input_channels=1, p_baseline=p_baseline, weight_fa_std=weight_fa_std, weight_r_range=weight_r_range, weight_fa_learning=weight_fa_learning, recurrent_input=recurrent_input, weight_r_learning=weight_r_learning, n_hidden_layers=n_hidden_layers, device=device).to(device)
